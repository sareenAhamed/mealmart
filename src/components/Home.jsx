  ...
  return (
    ...
    >
      <div className="p-14 rounded-lg bg-black opacity-70">
        ...
        <button className="mt-6 px-6 py-2 text-sm md:text-base bg-white text-orange-500 font-semibold rounded-full hover:bg-orange-500 hover:text-white transition-all duration-300">
          View Menu
        </button>
      </div>
    </div>
